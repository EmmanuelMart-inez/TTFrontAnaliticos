...
export default function PromoCard(props) {
  ...
  return (
    <div class="ui link cards" style={{ height: "80px" }}>
      <div class="card">
        <div class="content">
          <img class="right floated mini ui image" src={tile.notificacion.imagenIcon} />
          <div
            class="header"
          ...
          <div class="meta">{tile.notificacion.fecha && parseISOString(tile.notificacion.fecha) || ""}</div>
          <div
            class="description"
